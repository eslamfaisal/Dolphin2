...
public class TechnicalRegisterActivity extends LocationBaseActivity implements
    ...
    List<String> specializationIDs = new ArrayList<>();
    List<Specialize> specializations = new ArrayList<>();

    String SPECIALIZE_ID = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        choose_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ImagePicker.create(TechnicalRegisterActivity.this)
                        .limit(1)
                        .theme(R.style.UCrop)
                        .folderMode(true)
                        .start();
    ...
    void creatAccount() {
        ...
        if (
            ...
            apis.registerUser(
                    ...
                    Integer.parseInt(SPECIALIZE_ID),
                    image
                ...
                public void onResponse(Call<RegisterResponse> call, Response<RegisterResponse> response) {
                    ...
                    if (response.body().getSuccess_signup() == 1) {
                        ...
                        Toast.makeText(TechnicalRegisterActivity.this, getString(R.string.registerd), Toast.LENGTH_SHORT).show();
                    }
                ...
                public void onFailure(Call<RegisterResponse> call, Throwable t) {
                    Toast.makeText(TechnicalRegisterActivity.this, "حدث خطا", Toast.LENGTH_SHORT).show();
    ...
    private void getSpecializations() {
        ...
        BaseClient.getApi().getSpecializes().enqueue(new Callback<List<Specialize>>() {
            @Override
            public void onResponse(Call<List<Specialize>> call, Response<List<Specialize>> response) {
                if (response.body() != null) {
                    if (response.body().size() > 0) {
                        specializations = response.body();


                        for (Specialize specialize : specializations) {
                            specializationNames.add(specialize.getAr_services_title());
                            specializationIDs.add(specialize.getId_services());
                        }

                        ArrayAdapter adapter = new ArrayAdapter(getApplicationContext(), android.R.layout.simple_spinner_dropdown_item, specializationNames);
                        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                        ...
                        specializationSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                            @Override
                            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                                SPECIALIZE_ID = String.valueOf(specializationIDs.get(position));
                                Log.d("onItemSelected", "onItemSelected: "+SPECIALIZE_ID);
            ...
            @Override
            public void onFailure(Call<List<Specialize>> call, Throwable t) {
