...
public class CurrentOrdersAdapters extends RecyclerView.Adapter <CurrentOrdersAdapters.Holder>{

    List<OrderResponse >orders ;
    Context context;

    public CurrentOrdersAdapters(List<OrderResponse> orders, Context context) {
        this.orders = orders;
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        return new Holder(LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_current_order_item,parent,false));
    }
